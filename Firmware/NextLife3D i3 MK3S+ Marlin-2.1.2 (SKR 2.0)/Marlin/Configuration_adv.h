 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD  40       // Seconds //JC
  #define THERMAL_PROTECTION_HYSTERESIS 8     // Degrees Celsius //JC

  #define ADAPTIVE_FAN_SLOWING              // Slow part cooling fan if temperature drops //JC
  #if BOTH(ADAPTIVE_FAN_SLOWING, PIDTEMP)
    #define NO_FAN_SLOWING_IN_PID_TUNING    // Don't slow fan speed during M303 //JC
  #endif
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  40               // Seconds //JC
  #define WATCH_TEMP_INCREASE 2               // Degrees Celsius //JC
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        20 // Seconds //JC
  #define THERMAL_PROTECTION_BED_HYSTERESIS     8 // Degrees Celsius //JC

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                60 // Seconds //JC
 ...
 */
#define FAN_KICKSTART_TIME    100  // (ms) //JC
...
#define HOMING_BUMP_MM      { 0, 0, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump //JC
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing //JC
...
#define DISABLE_INACTIVE_Z false // Set 'false' if the nozzle could fall onto your printed part! //JC
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING //JC
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //JC
  ...
  #define LCD_TIMEOUT_TO_STATUS 15000   // (ms) //JC
  ...
  #define STATUS_MESSAGE_SCROLLING //JC
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY //JC
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   false // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
    //#define BACKUP_POWER_SUPPLY       // Backup power / UPS to move the steppers on power loss
    //#define POWER_LOSS_ZRAISE       2 // (mm) Z axis raise on resume (on power loss with UPS)
    //#define POWER_LOSS_PIN         44 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
    //#define POWER_LOSS_STATE      LOW // State of pin indicating power loss //JC
    //#define POWER_LOSS_PULLUP         // Set pullup / pulldown as appropriate for your sensor
    //#define POWER_LOSS_PULLDOWN
    //#define POWER_LOSS_PURGE_LEN   20 // (mm) Length of filament to purge on resume //JC
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true  // Pre-allocate a static array for faster pre-sorting. //JC
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true  // Keep sorted items in RAM longer for speedy performance. Most expensive option. //JC
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' //JC
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu //JC
   ...
   */
  #define SDCARD_CONNECTION LCD //JC
...
#define BABYSTEPPING //JC
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. //JC
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    #define DOUBLECLICK_MAX_INTERVAL 800   // Maximum interval between clicks, in milliseconds. //JC
                                            // Note: Extra time may be added to mitigate controller latency.
    #define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle. //JC
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //JC
 ...
 */
#define LIN_ADVANCE //JC
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.0 }    // (mm) Compression length per 1mm/s extruder speed, per extruder //JC
  #else
    #define ADVANCE_K 0.0        // (mm) Compression length applying to all extruders //JC
  #endif
 ...
 */
//#define PTC_PROBE    // Compensate based on probe temperature //JC
//#define PTC_BED      // Compensate based on bed temperature /JC
//#define PTC_HOTEND   // Compensate based on hotend temperature
  ...
  // G76 options
    ...
    #define PTC_PARK_POS   { 245, 6, 105 }  // right-front //JC

    // Probe position to probe and wait for probe to reach target temperature
    #define PTC_PROBE_POS  { 127.5, 106.3 } // middle //JC
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32 //JC
#else
 ...
 */
#define ADVANCED_PAUSE_FEATURE //JC
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     20  // (mm/s) Unload filament feedrate. This can be pretty fast. //JC
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      120  // (mm) The length of filament for a complete unload. //JC
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   2  // (mm/s) Slow move when starting load. //JC
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    40  // (mm) Slow length, to allow time to insert material. //JC
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    60  // (mm) Load length of filament, from extruder gear to nozzle. //JC
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        3  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_PURGE_LENGTH         60  // (mm) Length to extrude after loading. //JC
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT        2  // (mm) Unload initial retract length. //JC
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. //JC
  #define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change //JC

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. //JC
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       500        // (mA) RMS current. Multiply by 1.414 for peak current. //JC
    #define X_CURRENT_HOME  ((X_CURRENT) / 2)  // (mA) RMS current for sensorless homing //JC
    ...
    #define Y_CURRENT       600 //JC
    #define Y_CURRENT_HOME  ((Y_CURRENT) / 2) //JC
    ...
    #define E0_CURRENT      350 //JC
    #define E0_MICROSTEPS    32 //JC
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) //JC
   ...
   */
  #define MONITOR_DRIVER_STATUS //JC
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only //JC

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  90 //JC
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  100 //JC
    ...
    #define IMPROVE_HOMING_RELIABILITY //JC
  #endif
   ...
   */
  #define SQUARE_WAVE_STEPPING //JC
 ...
 */
#define STARTUP_COMMANDS "M17 Z" //JC
 ...
 */
#define HOST_ACTION_COMMANDS //JC
...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_CURRENT    (Z_CURRENT/2) // Default calibration current in ma //JC
